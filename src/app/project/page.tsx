      ...
      <main className="pt-18 min-h-screen bg-gradient-to-br from-gray-950 via-purple-950/20 to-gray-950">
        ...
        <section className="px-6 py-20">
                <div className="max-w-6xl mx-auto text-center">
                  <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-purple-400 via-pink-400 to-purple-600 bg-clip-text text-transparent">
                    Projects
                  </h1>
                  <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                    A collection of my work from websites to applications and more.
                  </p>
